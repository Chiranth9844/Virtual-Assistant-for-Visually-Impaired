...
#project_id = "blind-assistant-364106"
project_id = "blind-bot-yohm"
...
intent = None
while True:
    #cam = cv2.VideoCapture(0) #for default camera   use this while running in the laptop
    cam = cv2.VideoCapture(1) #for secondary camera
